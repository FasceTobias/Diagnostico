...
const FAMILIES = [
  /* Plus Jakarta Sans es la voz de la app. Una sans moderna con carácter
     propio —la a, la g y la y tienen dibujo— pero sin redondeces: al lado
     de Nunito se lee más adulta y más editorial, que es justo lo que le
     faltaba. Variable de 200 a 800, así que hay 450 y 650 de verdad y no
     hay que fingirlos con dos archivos. */
  { q: 'Plus+Jakarta+Sans:wght@300..800', name: 'Plus Jakarta Sans', file: 'jakarta', out: 'app' },
