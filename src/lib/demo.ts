...
const demo = (
  m: Omit<Meal, 'isDemo' | 'carbsVerified' | 'buyOutside'> & { buyOutside?: boolean },
): Meal => ({ buyOutside: false, ...m, carbsVerified: false, isDemo: true })
...
const afuera = (
  m: Omit<
    ...
    | 'portable' | 'prepMinutes' | 'mainIngredient'
  >,
): Meal =>
  demo({
    ...m,
