...
/** Opción que se compra afuera. Nunca entra en la rotación del plan:
    aparece sólo cuando la pedís desde «Resolver ahora». */
const comprable = (
  m: Omit<Meal, 'isDemo' | 'carbsVerified' | 'buyOutside' | 'prepSteps' | 'makeNightBefore' | 'freezable' | 'needsCold' | 'needsReheat' | 'difficulty' | 'tested'> & {
    needsReheat?: boolean
  },
): Meal =>
  demo({
    ...
    buyOutside: true,
    needsCold: false,
    needsReheat: m.needsReheat ?? false,
...
export const DEMO_MEALS: Meal[] = [
  ...
  /* ------------------------------------------------------------------
     PARA COMPRAR AFUERA — también DEMO

     Estas opciones existen para que «Resolver ahora» tenga qué ofrecer
     cuando estás en la calle sin comida. Los carbohidratos son órdenes de
     magnitud, no datos: dependen del lugar, del tamaño y de la receta de
     quien la hizo. Por eso van todas con confianza estimada y sin verificar.

     La biblioteca real de lo que comprás afuera la vamos a armar con
     productos y lugares concretos.
     ------------------------------------------------------------------ */
  comprable({
    id: 'c-cafe-medialunas',
    name: 'Café con leche y medialunas',
    category: 'desayuno',
    tags: ['emergencia', 'rápido', 'normal'],
    mainIngredient: 'panadería',
    ingredients: ['Café con leche', 'Medialunas 2'],
    portion: '1 taza + 2 medialunas',
    carbs: 50,
    carbSource: 'estimación',
    confidence: 'estimada',
    prepMinutes: 5,
    ...
    portable: true,
    favorite: false,
    notes: 'Los carbos varían mucho según el tamaño de la medialuna.',
    venues: ['panadería', 'cafetería', 'estación de servicio'],
    priceLevel: 1,
    handheld: true,
  }),
  comprable({
    ...
    portable: true,
    favorite: false,
    venues: ['cafetería', 'panadería', 'casa de comidas'],
    priceLevel: 1,
    handheld: true,
  }),
  comprable({
    ...
    name: 'Empanadas',
    category: 'almuerzo',
    tags: ['emergencia', 'rápido', 'potente'],
    mainIngredient: 'empanada',
    ingredients: ['Empanadas 3'],
    portion: '3 unidades',
    carbs: 60,
    carbSource: 'estimación',
    confidence: 'estimada',
    ...
    venues: ['rotisería', 'casa de comidas'],
    priceLevel: 1,
    handheld: true,
  }),
  comprable({
    ...
    category: 'almuerzo',
    tags: ['emergencia', 'potente'],
    mainIngredient: 'milanesa',
    ingredients: ['Pan', 'Milanesa', 'Lechuga', 'Tomate'],
    portion: '1 sándwich grande',
    carbs: 55,
    carbSource: 'estimación',
    confidence: 'estimada',
    prepMinutes: 10,
  ...
  comprable({
    id: 'c-ensalada-rotiseria',
    name: 'Ensalada con pollo de rotisería',
    category: 'almuerzo',
    tags: ['normal'],
    mainIngredient: 'pollo',
    ingredients: ['Lechuga', 'Tomate', 'Zanahoria', 'Pollo', 'Huevo'],
    portion: '1 porción',
    carbs: 18,
    carbSource: 'estimación',
    confidence: 'estimada',
    ...
    portable: true,
    favorite: false,
    notes: 'Pocos carbos. Puede quedar corta si el día fue largo.',
    venues: ['rotisería', 'restaurante', 'casa de comidas'],
    priceLevel: 2,
    handheld: false,
  }),
  comprable({
    id: 'c-tarta',
    name: 'Porción de tarta de verdura',
    category: 'almuerzo',
    tags: ['rápido', 'normal'],
    mainIngredient: 'tarta',
    ingredients: ['Masa', 'Acelga o espinaca', 'Huevo', 'Queso'],
    portion: '1 porción',
    carbs: 38,
    carbSource: 'estimación',
    confidence: 'estimada',
    ...
    portable: true,
    favorite: false,
    venues: ['rotisería', 'panadería', 'casa de comidas'],
    priceLevel: 1,
    handheld: true,
  }),
  comprable({
    id: 'c-yogur-super',
    name: 'Yogur con fruta de supermercado',
    category: 'snack',
    tags: ['emergencia', 'rápido', 'liviano'],
    mainIngredient: 'yogur',
    ingredients: ['Yogur 1 pote', 'Banana o manzana 1'],
    portion: '1 pote + 1 fruta',
    carbs: 34,
    carbSource: 'etiqueta',
    confidence: 'estimada',
    prepMinutes: 3,
    ...
    venues: ['supermercado', 'kiosco'],
    priceLevel: 1,
    handheld: true,
  }),
  comprable({
    id: 'c-frutos-secos',
    name: 'Mix de frutos secos de kiosco',
    category: 'snack',
    tags: ['emergencia', 'rápido', 'liviano'],
    mainIngredient: 'frutos secos',
    ingredients: ['Mix de frutos secos 1 paquete'],
    portion: '1 paquete chico',
    carbs: 10,
    carbSource: 'etiqueta',
    confidence: 'estimada',
    prepMinutes: 1,
    ...
    portable: true,
    favorite: false,
    notes: 'Si tiene pasas o arándanos, los carbos suben bastante.',
    venues: ['kiosco', 'supermercado', 'estación de servicio'],
    priceLevel: 2,
    handheld: true,
  }),
  comprable({
    id: 'c-sandwich-cafeteria',
    name: 'Sándwich de cafetería',
    category: 'merienda',
    tags: ['rápido', 'potente'],
    mainIngredient: 'pan',
    ...
    portable: true,
    favorite: false,
    venues: ['cafetería', 'panadería'],
    priceLevel: 2,
    handheld: true,
  }),
  comprable({
    id: 'c-pollo-guarnicion',
    name: 'Pollo con guarnición de rotisería',
    category: 'cena',
    tags: ['potente'],
    mainIngredient: 'pollo',
    ingredients: ['Cuarto de pollo', 'Puré o papas o arroz'],
    portion: '1 porción',
    carbs: 45,
    carbSource: 'estimación',
    confidence: 'estimada',
